...
!define PRODUCT_NAME "Анкат-7664МИКРО"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Анкат-7664МИКРО"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\ankatmicro.exe"
...
OutFile "ankatmicro-setup.exe"
InstallDir "$PROGRAMFILES\Анкат-7664МИКРО"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Анкат-7664МИКРО.lnk" "$INSTDIR\ankatmicro.exe"
  CreateShortCut "$DESKTOP\Анкат-7664МИКРО.lnk" "$INSTDIR\ankatmicro.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\ankatmicro.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\ankatmicro.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Анкат-7664МИКРО.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\Анкат-7664МИКРО.lnk"
